...
(DEFMETHOD SYSTEM::NKI
  ((SYSTEM::SELF SYSTEM::HARP) (TYPE T) (SYSTEM::EXPRESSION TRILLO))
  #P"8. Section Strings/1. Violins 1/Vlns 1 Trills H.nki")

(DEFMETHOD SYSTEM::NKI
  ((SYSTEM::SELF SYSTEM::HARP) (TYPE T) (SYSTEM::EXPRESSION TREMOLO))
...
(DEFMETHOD SYSTEM::NKI
  ((SYSTEM::SELF SYSTEM::HARP) (TYPE T) (SYSTEM::EXPRESSION PIZZICATO))
  #P"7. Solo Strings/2. Viola/Viola Pizz Solo.nki")

(DEFMETHOD SYSTEM::NKI
  ((SYSTEM::SELF SYSTEM::HARP) (TYPE T) (SYSTEM::EXPRESSION HARMONICS))
