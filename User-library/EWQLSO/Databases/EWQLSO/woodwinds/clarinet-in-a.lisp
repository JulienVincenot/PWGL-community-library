...
(DEFMETHOD NKI
  ((SELF CLARINET-IN-A) (TYPE T) (EXPRESSION STACCATO))
  #P"Woodwinds/Solo Clarinet/2 Short/F 3Cl Stac.nki")

(DEFMETHOD NKI
  ((SELF CLARINET-IN-A) (TYPE T) (EXPRESSION TRILLO))
...
(DEFMETHOD NKI
  ((SELF CLARINET-IN-A) (TYPE T) (EXPRESSION ACCENT))
  #P"Woodwinds/Solo Clarinet/2 Short/F SCL Marc.nki")

(DEFMETHOD NKI
  ((SELF CLARINET-IN-A) (TYPE T) (EXPRESSION SLUR))
