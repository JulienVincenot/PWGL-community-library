...
(defclass GM-player (midi-play-device) ()) ;;; to test a soft soundfont synth via IAC ???!!
...
(add-play-device 'GM-player "GM-player")
...
(defmethod prepare-Midi-play*((output GM-player) score)
...
(defmethod calc-play-chan/midi* ((output GM-player) (self note))
