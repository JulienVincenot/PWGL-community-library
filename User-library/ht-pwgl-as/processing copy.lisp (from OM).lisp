...
;;; FORMAT SVP COMMAND
(om::defmethod! make-svp-command (srcpath processings begin end
...
(om::defmethod! supervp-processing ((srcpath om::sound) processings begin end windowsize fftsize windowstep-oversamp 
                                     window-type shape-invariant preserve-transient
                                     normalize outfile)
  :icon 950 
