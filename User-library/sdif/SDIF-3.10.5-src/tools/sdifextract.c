...
void usage (char *msg, char *arg, int longhelp)
{
    ...
    fprintf (SdifStdErr, "\n\n"
"Usage: sdifextract [options] [infile [outfile]] LISP-ified VERSION\n"
"\n"  
...
outfft (OutAction what, double data)
{
	...
	case BeginMatrix:  fprintf (out, "(\n"); break;
	case EndMatrix:    fprintf (out, ")\n"); break;
	case EndFrame:	   fprintf (out, ")\n"); break;
	default:	    /* do nothing */			break;
			    
	case BeginRow:	  
							fprintf (out, "(%f ", time);	break;
